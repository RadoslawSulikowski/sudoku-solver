...
import static pl.radoslawsulikowski.sudokusolver.solvercommon.SudokuField.EMPTY;
...
public class SudokuBoard {
    ...
    pl.radoslawsulikowski.sudokusolver.solvercommon.SudokuField[] getBoard() {
        return board;
    }

    public pl.radoslawsulikowski.sudokusolver.solvercommon.SudokuField getFieldByFieldNumber(int fieldNumber) {
    ...
    void recoverBoard(SudokuBoard backtrackBoard) {
    ...
    public boolean hasDuplicateValuesInRowColumnOrSection() {
    ...
    void addBoardToBacktracksAndSetOneOfCandidatesAsValue(Deque<Backtrack> backtracks) {
